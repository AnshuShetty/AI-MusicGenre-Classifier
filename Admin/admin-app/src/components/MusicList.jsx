...
const MusicList = () => {
  ...
  const genreBackgrounds = {
    Bollywood: 'linear-gradient(180deg, #ff7eb3, #000000)', // Bollywood gradient
    bolly_romantic: 'linear-gradient(180deg, #ff8c00, #000000)', // Romantic gradient
    hiphop: 'linear-gradient(180deg, #ff0080, #8a2be2)', // Hip-hop gradient
    pop: 'linear-gradient(180deg, #ff4500, #ff6347)', // Pop gradient
    Rock: 'linear-gradient(180deg, #ff4500, #ff6347)', // rock gradient
    Electronic: 'linear-gradient(180deg, #ff4500, #ff6347)',
