  ...
  return (
    <>
      ...
      <div className="genre-links">
        ...
        <Link to="/dashboard/bolly_romantic" className="genre-link genre-romantic">BollyRomantic</Link>
      ...
      <div className="row">
      <div className="genre-links">
        <Link to="/dashboard/rock" className="genre-link genre-rock">Ghazal</Link>
        <Link to="/dashboard/jazz" className="genre-link genre-electronic">BollyRap</Link>
        <Link to="/dashboard/carnatic" className="genre-link genre-romantic">Carnatic</Link>
        <Link to="/dashboard/sufi" className="genre-link genre-pop">Sufi</Link>
      </div>
      </div>
      </div>
    </>
